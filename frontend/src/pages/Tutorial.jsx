...
const STEPS = [
  {
    title: (<>Welcome to <AskDBLogo size="md" /></>),
    ...
    content: "AskDB is your AI-powered analytics copilot. Ask questions about your data in plain English and get instant SQL queries, charts, and insights.",
  },
  {
    ...
    content: "Connect your database with read-only credentials. AskDB auto-discovers your schema and can never modify your data.",
  },
  {
    title: "Ask Questions",
    ...
    content: "Type any business question. AskDB generates SQL, shows it for your review, and executes only after your approval. Human-in-the-loop safety.",
  },
  {
