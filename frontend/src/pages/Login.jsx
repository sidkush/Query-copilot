          ...
          <div className="max-h-52 overflow-y-auto">
            {filtered.map((c) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 text-sm hover:bg-gray-700/60 transition cursor-pointer ${
                  c.code === value ? "bg-indigo-600/20 text-white" : "text-gray-300"
                }`}
              >
                          ...
                          {[1, 2, 3, 4, 5].map((i) => (
                            <div
                              ...
                              className={`h-1 flex-1 rounded-full transition-colors ${
                                i <= pwdStrength.score ? pwdStrength.color : "bg-gray-700"
                              }`}
                            />
                          ))}
                        </div>
                  ...
                  <motion.div variants={fieldItem}>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full glass-input rounded-lg px-4 py-2.5 pr-10 text-white focus:outline-none transition ${
                          passwordsMismatch
