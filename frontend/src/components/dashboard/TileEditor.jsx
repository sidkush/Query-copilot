...
const CHART_TYPES = [
  ...
  { key: 'globe_3d', label: 'Globe', family: 'wow', icon: <svg viewBox="0 0 24 24" width="20" height="20"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" strokeWidth="1.4"/><path d="M12 3a9 9 0 010 18M3 12h18M5.5 6.5c2 1 4.5 1.5 6.5 1.5s4.5-.5 6.5-1.5M5.5 17.5c2-1 4.5-1.5 6.5-1.5s4.5.5 6.5 1.5" fill="none" stroke="currentColor" strokeWidth="1.2" opacity=".55"/></svg> },
